...
--
-- Host: 127.0.0.1
-- Generation Time: 2023-09-28 02:43:59
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `shop_data` (`id`, `gid`, `src`, `title`, `price`, `num`, `totalMoney`, `checked`) VALUES
(12, 1021, 'u1.png', 'Redmi K60 至尊版 天玑9200+ 独显芯片X7 1.5K直屏 索尼IMX800 光学防抖 16GB+512GB 墨羽 小米红米K60 Ultra', '27.11', 10, '271.10', 1),
(13, 1016, 'p1.png', '华为笔记本电脑MateBook 14 2023 13代酷睿版 i5 16G 1T 14英寸轻薄办公本/2K触控全面屏/手机互联 深空灰', '89.00', 1, '89.00', 1),
(14, 1003, 'c1.png', '宝矿力水特电解质水功能性运动饮料500ml*15瓶 整箱装 快速补充能量水分', '67.45', 1, '67.45', 0),
(15, 1007, 'g1.png', '比比赞（BIBIZAN）牛角酥混合味400g独立装虎牙脆妙脆角膨化饼干休闲零食品小吃', '78.99', 3, '236.97', 0),
(16, 1002, 'b1.png', '【运动提速剂】动能加冲级者体考小红瓶兴奋液体氮泵跑步三公里体测神器爆发力体考兴奋耐力专用补充剂运动 【爆发型】1瓶+【耐力型】1瓶', '12.99', 1, '12.99', 0),
(17, 1008, 'h1.png', 'YONEX尤尼克斯护腕跑步健身舒适吸汗运动护腕AC029CR-002蓝色单个装', '12.87', 1, '12.87', 0);
...
INSERT INTO `userinfo` (`id`, `account`, `passwrod`, `username`, `tel`, `email`, `addr`) VALUES
(1, '13552321519', '123456', '阮征霆', '13552321519', '13552321519@163.com', ''),
(2, '文字', '11', '11', '11', '11', ''),
(4, '孙宇航', '123456', '孙宇航', '15527789878', '111', ''),
(5, '颜蕊', '111', '颜蕊', '11111', '11', ''),
(6, '刘欣冉', '111111', '刘欣冉', '16767', '11', ''),
(7, '1234324324', '443', '1234324324', '23', '21', '');
...
(5, 1001, '零食', 'a1.png', 'a1.png,a2.png,a3.png,a4.png', 'Yottoy英国浸塑哑铃男士女士健身家用肌肉塑形实心小哑铃力量训练器材初学者-柚清绿一对装', '78.99', 1, '七天无理由', 0),
(6, 1002, '手机', 'b1.png', 'b1.png,b2.png,b3.png,b4.png', '【运动提速剂】动能加冲级者体考小红瓶兴奋液体氮泵跑步三公里体测神器爆发力体考兴奋耐力专用补充剂运动 【爆发型】1瓶+【耐力型】1瓶', '12.99', 1, '七天无理由', 0),
(7, 1003, '电脑', 'c1.png', 'c1.png,c2.png,c3.png,c4.png', '宝矿力水特电解质水功能性运动饮料500ml*15瓶 整箱装 快速补充能量水分', '67.45', 2, '七天无理由', 0),
...
(12, 1008, '电脑', 'h1.png', 'h1.png,h2.png,h3.png,h4.png', 'YONEX尤尼克斯护腕跑步健身舒适吸汗运动护腕AC029CR-002蓝色单个装', '12.87', 3, '七天无理由', 0),
(13, 1009, '手机', 'i1.png', 'i1.png,i2.png,i3.png,i4.png', '汗马 【智能游戏APP】动感单车家用运动器材健身车室内脚踏自行车 【店长推荐】蓝牙游戏+加粗车架', '429.00', 1, '七天无理由', 0),
(14, 1010, '手机', 'j1.png', 'j1.png,j2.png,j3.png,j4.png', 'KDST健腹轮自动回弹收腹卷腹运动男女腹肌轮肘撑滚轮减肥健身器材家用 【活力橙】电子计时肘撑设计/健腹二合一/自动回弹', '68.09', 6, '七天无理由', 0),
...
(19, 1015, '零食', 'o1.png', 'o1.png,o2.png,o3.png,o4.png', '野马 夏季轻便3C认证儿童头盔 均码 白色熊猫(透长镜+赠咖短镜)', '78.99', 1, '七天无理由', 0),
...
(35, 1032, '图书', 'ee1.png ', 'ee1.png,ee2.png,ee3.png', '【包邮】余华作品 活着（精装版，余华代表作，易烊千玺推荐阅读 新版） ', '99.12', 4, '七天无理由', 0),
